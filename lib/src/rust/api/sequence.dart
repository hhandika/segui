...
Future<String> showDnaUppercase({dynamic hint}) =>
    RustLib.instance.api.crateApiSequenceShowDnaUppercase(hint: hint);
...
class AlignmentServices {
  ...
  static Future<AlignmentServices> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequenceAlignmentServicesNew(hint: hint);
...
class FilteringServices {
  ...
  Future<void> filter({dynamic hint}) => RustLib.instance.api
      .crateApiSequenceFilteringServicesFilter(that: this, hint: hint);

  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<FilteringServices> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequenceFilteringServicesNew(hint: hint);
...
class IDExtractionServices {
  ...
  Future<void> extractId({dynamic hint}) => RustLib.instance.api
      .crateApiSequenceIdExtractionServicesExtractId(that: this, hint: hint);

  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<IDExtractionServices> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequenceIdExtractionServicesNew(hint: hint);
...
class PartitionServices {
  ...
  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<PartitionServices> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequencePartitionServicesNew(hint: hint);
...
class SequenceConversionServices {
  ...
  Future<void> convertSequence({dynamic hint}) => RustLib.instance.api
      .crateApiSequenceSequenceConversionServicesConvertSequence(
          that: this, hint: hint);

  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<SequenceConversionServices> newInstance({dynamic hint}) =>
      RustLib.instance.api
          .crateApiSequenceSequenceConversionServicesNew(hint: hint);
...
class SequenceExtraction {
  ...
  Future<void> extract({dynamic hint}) => RustLib.instance.api
      .crateApiSequenceSequenceExtractionExtract(that: this, hint: hint);

  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<SequenceExtraction> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequenceSequenceExtractionNew(hint: hint);
...
class SequenceRemoval {
  ...
  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<SequenceRemoval> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequenceSequenceRemovalNew(hint: hint);

  Future<void> removeSequence({dynamic hint}) => RustLib.instance.api
      .crateApiSequenceSequenceRemovalRemoveSequence(that: this, hint: hint);
...
class SequenceRenaming {
  ...
  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<SequenceRenaming> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequenceSequenceRenamingNew(hint: hint);

  Future<void> renameSequence({dynamic hint}) => RustLib.instance.api
      .crateApiSequenceSequenceRenamingRenameSequence(that: this, hint: hint);
...
class SplitAlignmentServices {
  ...
  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<SplitAlignmentServices> newInstance({dynamic hint}) =>
      RustLib.instance.api
          .crateApiSequenceSplitAlignmentServicesNew(hint: hint);
...
class TranslationServices {
  ...
  // HINT: Make it `#[frb(sync)]` to let it become the default constructor of Dart class.
  static Future<TranslationServices> newInstance({dynamic hint}) =>
      RustLib.instance.api.crateApiSequenceTranslationServicesNew(hint: hint);
