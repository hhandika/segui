...
abstract class RustLibApi extends BaseApi {
  Future<ArchiveServices> crateApiArchiveArchiveServicesNew({dynamic hint});

  Future<void> crateApiArchiveArchiveServicesZip(
      {required ArchiveServices that, dynamic hint});

  Future<String> crateApiCommonGetApiVersion({dynamic hint});

  Future<void> crateApiCommonInitLogger({required String logDir, dynamic hint});

  Future<ContigServices> crateApiContigContigServicesNew({dynamic hint});
  ...
  Future<RawReadServices> crateApiReadsRawReadServicesNew({dynamic hint});
  ...
  Future<SequenceConversionServices>
      crateApiSequenceSequenceConversionServicesNew({dynamic hint});
  ...
  Future<SequenceRemoval> crateApiSequenceSequenceRemovalNew({dynamic hint});

  Future<void> crateApiSequenceSequenceRemovalRemoveSequence(
      {required SequenceRemoval that, dynamic hint});

  Future<SequenceRenaming> crateApiSequenceSequenceRenamingNew({dynamic hint});

  Future<void> crateApiSequenceSequenceRenamingRenameSequence(
      {required SequenceRenaming that, dynamic hint});

  Future<String> crateApiSequenceShowDnaUppercase({dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  @override
  Future<void> crateApiCommonInitLogger(
      {required String logDir, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
