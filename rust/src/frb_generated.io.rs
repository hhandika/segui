...
#[no_mangle]
pub extern "C" fn frbgen_segui_wire_SequenceExtraction_extract(port_: i64, that: usize) {
...
#[no_mangle]
pub extern "C" fn frbgen_segui_wire_SequenceRenaming_rename_sequence(port_: i64, that: usize) {
