...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__common__get_api_version_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__common__init_logger_impl(port, ptr, rust_vec_len, data_len),
        ...
        7 => wire__crate__api__csv__csv_summary_services_get_column_names_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        13 => wire__crate__api__sequence__alignment_services_concat_alignment_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__sequence__alignment_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__sequence__alignment_services_summarize_alignment_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__sequence__filtering_services_filter_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__sequence__filtering_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__sequence__id_extraction_services_extract_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__sequence__id_extraction_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__sequence__partition_services_convert_partition_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__sequence__partition_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
