...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__common__get_api_version_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__common__init_logger_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__contig__contig_services_new_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__contig__contig_services_summarize_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__csv__csv_summary_services_get_column_names_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__csv__csv_summary_services_get_line_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        10 => wire__crate__api__csv__csv_summary_services_parse_columns_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        12 => wire__crate__api__reads__raw_read_services_summarize_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__sequence__alignment_services_concat_alignment_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__sequence__alignment_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__sequence__alignment_services_summarize_alignment_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__sequence__filtering_services_filter_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__sequence__filtering_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__sequence__id_extraction_services_extract_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__sequence__id_extraction_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__crate__api__sequence__partition_services_convert_partition_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__sequence__partition_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__sequence__sequence_conversion_services_convert_sequence_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__sequence__sequence_conversion_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        34 => wire__crate__api__sequence__sequence_extraction_extract_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        33 => wire__crate__api__sequence__sequence_extraction_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        30 => wire__crate__api__sequence__sequence_removal_remove_sequence_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__crate__api__sequence__sequence_renaming_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        32 => wire__crate__api__sequence__sequence_renaming_rename_sequence_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        23 => wire__crate__api__sequence__split_alignment_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__sequence__split_alignment_services_split_alignment_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__sequence__translation_services_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__sequence__translation_services_translate_sequence_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
