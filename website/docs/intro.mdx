...
If you are interested in using SEGUL API in Python, we provide a Python binding called `pysegul`. You can write python using the api like using any python library. No Rust knowledge is needed. You can install it using pip:
