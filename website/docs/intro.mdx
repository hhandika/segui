...
SEGUL has a growing list of features to help you manipulate and summarize your phylogenomic datasets. You can install both GUI and CLI versions in the system that supports them. Each version operates in its own contained environment and does not interfere with the other.
