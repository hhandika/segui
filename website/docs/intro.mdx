...
| Linux x86_64 (static) | [download](https://github.com/hhandika/segul/releases/latest/download/segul-Linux-musl-x86_64.tar.gz) | For Linux with old GLIBC version. Common in HPC clusters.                           |
| Linux x86_64          | [download](https://github.com/hhandika/segul/releases/latest/download/segul-Linux-x86_64.tar.gz)      | For Linux with modern GLIBC version. Most recent Linux distribution, including WSL. |
