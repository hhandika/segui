...
:::tip
If you are using [conda](https://anaconda.org/bioconda/segul) on Linux or MacOS. You can install SEGUL using it. Make sure you have [bioconda](https://bioconda.github.io/) channel setup before installing SEGUL. To install SEGUL, use the following command:
