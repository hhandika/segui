...
:::warning
The mobile version of the GUI has limited capabilities in handling large number of files. Find out more in the [guideline for mobile users](gui-usage/general#specific-guideline-for-mobile-users).
:::
...
For using GUI application, we recommend starting with the [GUI Usage](./gui-usage/general) section. For using the CLI application, we recommend starting with the [CLI Overview](./cli-usage/overview) section. These sections provide general information about the app and how to use it.
