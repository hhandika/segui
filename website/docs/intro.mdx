...
:::info
SEGUL CLI is now available in [Bioconda](https://anaconda.org/bioconda/segul). It is available to install for Linux and MacOS users using [ARM](https://en.wikipedia.org/wiki/ARM_architecture_family) or [x86_64](https://en.wikipedia.org/wiki/X86-64) CPUs.
