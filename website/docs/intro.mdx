...
:::info
The mobile version of the GUI has limited capabilities in handling large number of files. For more details, check the [guideline for mobile users](gui-usage/general#specific-guideline-for-mobile-users).
:::
