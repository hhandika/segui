...
[Below](#quick-start-%EF%B8%8F), we provide a quick start to help you start with SEGUL. The quick start assumes familiarity with phylogenomic data and some experience using related tools. Detailed instructions on installing SEGUL are available in the [installation guidelines](/docs/installation/overview). We recommend checking the [GUI general usage](/docs/gui-usage/general)e the GUI app. To use the CLI application, we recommend starting with the [CLI Overview](/docs/cli-usage/overview) section. These sections provide an overview of the app, input and output formats, datatype, and other general information about the app. Please refer to the [support](/docs/support) section for questions, issues, or feedback about the app and its documentation. We also welcome collaboration and contribution.
