...
Most of the PySEGUL features follow the same code pattern, except for features that require specific paramaters, such as alignment filtering, sequence extraction and removal. For the latter, inputting directory or file path list is done through setter and paramaters using matching method. For example, to extract sequences using regular expression:

```python
# <Your code using similar code structure as above here...>

input_dir = 'tests/data'
# Or using a list of files
