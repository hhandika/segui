...
Follow the installation instruction for your operating system. The fastest installation route for CLI is using the pre-compiled binaries [here](/docs/installation/install_binary). Get the most up to date link for GUI installation [here](/docs/installation/install_gui).
